...
if (isset($_GET['approve'])){
    ...
    $result = mysqli_query($con, "UPDATE Loan SET Loan_Status='Approved' ,Loan_appr_time = NOW() WHERE Loan_code=$id");
...
if (isset($_GET['apptrash'])){
    $id =$_GET['apptrash']; //deleting feeds
    $result = mysqli_query($con, "DELETE FROM Loan WHERE Loan_code=$id");
